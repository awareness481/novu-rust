use crate::{
    ...
    messages::types::{
        MarkAllMessageAsRequestDto, MarkAs, MarkMessageActionAsSeenDto,
        MarkMessageAsRequestDtoMessageId, MessageMarkAsRequestDto, MessageResponseDto,
    },
    shared::PaginatedResponseDto,
};
use std::str::FromStr;
use std::sync::Arc;
use strum::Display;
