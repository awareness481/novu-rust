...
impl UpdateWorkflowOverrideResponseDto {
    pub fn new(_id: String, _organization_id: String, _environment_id: String, _workflow_id: String, _tenant_id: String, active: bool, preference_settings: models::PreferenceChannels, deleted: bool, created_at: String, updated_at: String) -> UpdateWorkflowOverrideResponseDto {
